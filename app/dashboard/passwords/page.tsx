  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-foreground-muted text-sm mt-1">Securely store and autofill your passwords</p>
      </div>
      ...
      <div className="card-glow rounded-xl p-12 flex flex-col items-center text-center">
        ...
        <h2 className="font-grotesk text-lg font-bold text-foreground mb-2">No saved passwords yet</h2>
      ...
      <div className="grid grid-cols-3 gap-4">
        {['Weak', 'Reused', 'Compromised'].map((label) => (
          <div key={label} className="card-glow rounded-xl p-4 text-center">
            <Shield className="w-5 h-5 text-foreground-muted mx-auto mb-2" />
            <p className="text-foreground-muted text-xs">{label}</p>
            <p className="text-foreground font-grotesk font-bold text-lg mt-1">0</p>
          </div>
        ))}
      </div>
    </div>
