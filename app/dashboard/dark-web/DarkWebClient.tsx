  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-foreground-muted text-sm mt-1">Surveillance of dark web markets for your credentials</p>
      </div>
      ...
      <div className="card-glow rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="text-foreground-muted text-xs">Monitored Email</p>
            <p className="text-foreground text-sm font-mono mt-0.5">{userEmail}</p>
          </div>
          <div className="text-right">
            <p className="text-foreground-muted text-xs">Last Scan</p>
            <p className="text-foreground-secondary text-sm mt-0.5 flex items-center gap-1">
        ...
        <p className="text-foreground-muted text-xs mt-2">Personal Free: 1 scan/month • Personal Pro: real-time monitoring</p>
      </div>

      {/* History */}
      <div className="card-glow rounded-xl p-5">
        <h2 className="font-grotesk font-semibold text-foreground text-sm mb-4">Scan History</h2>
          ...
          {history.map((h, i) => (
            <div key={i} className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-foreground-secondary text-sm">{h.date}</span>
              </div>
