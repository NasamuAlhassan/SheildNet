...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="text-center">
        ...
        <h1 className="font-grotesk text-2xl font-bold text-white mb-2">Check your inbox</h1>
  ...
  return (
    <>
      <h1 className="font-grotesk text-2xl font-bold text-white mb-1">Reset your password</h1>
      ...
      <Link href="/login" className="text-slate-500 hover:text-slate-300 text-sm flex items-center justify-center gap-1.5 mt-5">
        <ArrowLeft className="w-4 h-4" /> Back to sign in
      </Link>
    </>
  );
